...
class DistModule(nn.Module):
    ...
    def forward_iou(self, *args, **kwargs):
        # 只用于iou训练
        broadcast_buffers(self.module, self.bn_method)
        return self.module.forward_iou(*args, **kwargs)

    def forward_refine(self, *args, **kwargs):
        # 只用于renife训练
        broadcast_buffers(self.module, self.bn_method)
        return self.module.forward_refine(*args, **kwargs)
