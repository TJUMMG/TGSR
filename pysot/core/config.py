...
__C.DATASET.NAMES = (['LaSOT'])  # 由于只有一个，多加了[]
...
__C.DATASET.GOT10k.ROOT = '/media/HardDisk_new/DataSet/train/got_10k/crop511'
__C.DATASET.GOT10k.ANNO = '/media/HardDisk_new/DataSet/train/got_10k/train.json'
__C.DATASET.GOT10k.FRAME_RANGE = 1
__C.DATASET.GOT10k.NUM_USE = -1

__C.DATASET.LaSOT = CN()
__C.DATASET.LaSOT.ROOT = '/media/HardDisk_new/DataSet/train/lasot/crop511/'
__C.DATASET.LaSOT.ANNO = '/media/HardDisk_new/DataSet/train/lasot/train.json'
__C.DATASET.LaSOT.FRAME_RANGE = 1
...
__C.TRACK.NFS30 = CN(new_allowed=True)
__C.TRACK.LaSOT = CN(new_allowed=True)
__C.TRACK.DTB70 = CN(new_allowed=True)
