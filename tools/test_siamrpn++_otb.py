...
parser.add_argument('--dataset',default='OTB100',
                    type=str,help='datasets')
parser.add_argument('--config', default='./experiments/siamrpn_r50_l234_dwxcorr_otb/config.yaml',
                    type=str, help='config file')
parser.add_argument('--snapshot', default='./experiments/siamrpn_r50_l234_dwxcorr_otb/model.pth',
...
parser.add_argument('--model_save_name', default ='SiamRPN++_TGSR',
...
def main(traj_checkpoint, iou_checkpoint, refine_checkpoint, save_name=args.model_save_name):
    # load config
    ...
    # # 保存result_dict_save
    # result_dict_save_path = 'Val1001/pkl/' + model_name + '_' + args.dataset + '.pkl'
    # with open(result_dict_save_path, 'wb') as f:
    #     pickle.dump(result_dict_save, f, pickle.HIGHEST_PROTOCOL)

if __name__ == '__main__':

    main(traj_checkpoint ='./snapshot_test/traj_otb.pth',
         iou_checkpoint='./snapshot_test/ipn_rpnpp_otb',
         refine_checkpoint='./snapshot_test/rbn_rpnpp_otb')
