...
parser.add_argument('--config', default='./experiments/siammask_r50_l3/config.yaml',
                    type=str, help='config file')
parser.add_argument('--snapshot', default='./experiments/siammask_r50_l3/model.pth',
                    type=str,help='snapshot of models to eval')
parser.add_argument('--video', default='', type=str,help='eval one special video')
parser.add_argument('--vis', action='store_true',
                    help='whether visualzie result')
parser.add_argument('--model_save_name', default = 'SiamMask',
...
def main(traj_checkpoint, iou_checkpoint, refine_checkpoint,
    ...
    # # 保存result_dict_save
    # result_dict_save_path = 'Val1001/pkl/' + args.model_save_name + '_' + args.dataset + '.pkl'
...
if __name__ == '__main__':
    ...
    iou_checkpoint = './snapshot_test/ipn_mask.pth'
    refine_checkpoint = './snapshot_test/rbn_mask.pth'

    main(
         traj_checkpoint=traj_checkpoint,
